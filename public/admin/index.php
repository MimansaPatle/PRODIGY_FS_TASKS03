...
<main class="lg:ml-72 min-h-screen p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <a href="products.php" class="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">Manage Products</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <a href="inventory.php" class="bg-yellow-600 hover:bg-yellow-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">View Inventory</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <a href="orders.php" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">View Orders</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <a href="customers.php" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">View Customers</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <a href="categories.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">Manage Categories</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-2">
                <a href="analytics.php" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">📊 Analytics</a>
                <a href="reports.php" class="bg-slate-600 hover:bg-slate-700 text-white px-4 py-2 rounded-xl inline-block transition-colors">Reports</a>
            </div>
        </div>
    </div>
</main>
